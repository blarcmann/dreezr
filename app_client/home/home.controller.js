(function () {
    ...
    function homeCtrl ($scope, dreezrData, geolocation) {
      ...
      vm.pageHeader = {
        title: 'Dreezr',
        strapline: 'Find places to chao, work with free wifi near you!'
      };
      vm.sidebar = {
        content: "Looking for somewhere to eat, grab a coffee, sit and get a bit of work done...bla bla bla bla bla bla bla bla bla bla bla *a very big THANK YOU to Ruth Josh\'Ny for making my JS time in Akwa Ibom state worthwhile (my grammatically inclined english gehfren) >3 >3 >3* bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla..."
      };
